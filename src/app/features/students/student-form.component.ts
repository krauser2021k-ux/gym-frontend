                        ...
                        <div>
                            ...
                            @if (isFieldInvalid('email')) {
                                <p class="mt-1 text-sm text-red-400">
                                    @if (studentForm.hasError('required', 'email')) {
                                        El email es requerido
                                    } @else if (studentForm.hasError('email', 'email')) {
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   class="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white  focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all"
                                   placeholder="70.5">
                            @if (studentForm.hasError('min', 'weight')) {
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   class="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white  focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all"
                                   placeholder="175">
                            @if (studentForm.hasError('min', 'height')) {
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea formControlName="medicalNotes"
                                      rows="3"
                                      class="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white  focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-transparent transition-all resize-none"
    ...
    async onSubmit(): Promise<void> {
        ...
        try {
            ...
            if (this.selectedFile) {
                photoUrl = await lastValueFrom(this.studentService.uploadPhoto(this.selectedFile));
            }
