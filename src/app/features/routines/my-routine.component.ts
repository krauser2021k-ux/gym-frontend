                ...
                <div class="glass rounded-lg p-6">
                    ...
                    @if (selectedDayWorkout()) {
                            ...
                            'border-white/20 hover:border-blue-500/50': !isBlockCompleted(block)
                                        ...
                                        <div class="flex items-center justify-between mt-4 pt-4 border-t border-white/10">
                                            <div class="flex items-center gap-2 text-white/70">
                                                ...
                                                <span class="text-sm">{{ block.exercises.length }}
                                                    ejercicio{{ block.exercises.length !== 1 ? 's' : '' }}</span>
                                            </div>
                                ...
                                <div class="glass rounded-lg p-6 mb-6">
                                    ...
                                    <div class="flex items-center gap-4 mt-4">
                                        <div class="flex items-center gap-2 text-white/70">
                                            ...
                                            <span class="text-sm">{{ selectedBlock()!.exercises.length }}
                                                ejercicios</span>
                                        </div>
                                        <div class="text-sm font-semibold"
                                             [ngClass]="{
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            @if (exercise.muscleGroups && exercise.muscleGroups.length > 0) {
                                                                <div class="flex flex-wrap gap-1 mt-2">
                                                                    @for (
                                                                            muscle of exercise.muscleGroups; track muscle) {
                        ...
                        <div class="text-center py-12">
                            <svg class="mx-auto h-12 w-12 text-white/40" fill="none" viewBox="0 0 24 24"
                                 stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      ...
                      {{
                        ...
                        {{ equipment }}
                            ...
                            @if (exerciseDetail()!.exercise.suggestedSets || exerciseDetail()!.exercise.suggestedReps || exerciseDetail()!.exercise.suggestedRest) {
                                <div class="glass rounded-lg p-4">
                                    <div class="text-sm text-white/60 mb-3 font-semibold">Recomendaciones Generales
                                    </div>
                                    <div class="space-y-2 text-white/80">
                                        @if (exerciseDetail()!.exercise.suggestedSets) {
                                            <p><span
                                                    class="font-semibold">Series sugeridas:</span> {{ exerciseDetail()!.exercise.suggestedSets }}
                                            </p>
                                        }
                                        @if (exerciseDetail()!.exercise.suggestedReps) {
                                            <p><span
                                                    class="font-semibold">Repeticiones sugeridas:</span> {{ exerciseDetail()!.exercise.suggestedReps }}
                                            </p>
                                        }
                                        @if (exerciseDetail()!.exercise.suggestedRest) {
                                            <p><span
                                                    class="font-semibold">Descanso sugerido:</span> {{ exerciseDetail()!.exercise.suggestedRest }}
                                            </p>
                                        }
                                    </div>
                                </div>
                            ...
                            @if (exerciseDetail()!.exercise.keyInstructions && (exerciseDetail()!.exercise.keyInstructions?.length ?? 0) > 0) {
                                <div class="glass rounded-lg p-4">
                                    ...
                                    <ul class="space-y-2">
                                        @for (
                                                instruction of exerciseDetail()!.exercise.keyInstructions; track instruction) {
                                            <li class="flex items-start gap-2 text-white/80">
                                                <svg class="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0"
                            ...
                            @if (exerciseDetail()!.exercise.videoUrl) {
                                <div class="glass rounded-lg p-4">
                                    ...
                                    <a [href]="exerciseDetail()!.exercise.videoUrl" target="_blank"
